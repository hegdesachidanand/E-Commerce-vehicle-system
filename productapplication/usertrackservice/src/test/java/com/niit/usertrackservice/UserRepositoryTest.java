...
//    }
//    @Test
//    public void givenUserToSaveUserNegativeCase(){
//        userTrackRepository.insert(user);
//        User user1= userTrackRepository.findById(user.getUserId()).get();
//        assertNotEquals("raj",user.getUserName());
//    }
//    @Test
//    public void givenTrackToSaveTrack(){
//        user.setTracksList(tracksList);
//        userTrackRepository.insert(user);
//        User user1= userTrackRepository.findById(user.getUserId()).get();
//        assertNotNull(user1);
//        //harish
//        assertEquals(tracksList,user1.getTracksList());
//    }
//    @Test
//    public void givenTrackToSaveTrackNegativeCase(){
//        userTrackRepository.insert(user);
//        User user1= userTrackRepository.findById(user.getUserId()).get();
//        assertNotEquals(tracksList,user.getTracksList());
//    }
//    @Test
...
//      tracks.setTrackName("buleyana song");
//        user.setTracksList(tracksList);
//        tracksList= Arrays.asList(tracks);
//        userTrackRepository.insert(user);
//        User user1= userTrackRepository.findById(user.getUserId()).get();
...
//    }
//    @Test
//    public void updatingTrackNegativeCase(){
