...
//        mockMvc.perform(post("/api/v1/userdata/saveUserTrack/101")
//                .contentType(MediaType.APPLICATION_JSON)
//                .content(jsonToString(user))
...
//        mockMvc.perform(post("/api/v1/userdata/saveUserTrack/102")
//                        .contentType(MediaType.APPLICATION_JSON)
//                        .content(jsonToString(user)))
...
//        mockMvc.perform(get("/api/v1/userdata/getAllTracks/101")
//                .contentType(MediaType.APPLICATION_JSON)
//        ).andExpect(status().isOk()).andDo(MockMvcResultHandlers.print());
...
//        mockMvc.perform(get("/api/v1/userdata/getAllTracks/102")
//                .contentType(MediaType.APPLICATION_JSON)
//        ).andExpect(status().isNotFound()).andDo(MockMvcResultHandlers.print());
//        verify(userTrackService,times(1)).getAllUserTrackFromWishList(anyString());
//    }
